const quizData = [
  ...
  {
    question: '45. Motivasi menurut Herzberg dipengaruhi oleh faktor...',
    choices: [
  ...
  {
    question: '46. Pengawasan "concurrent" dilakukan...',
    choices: [
      'Sebelum kegiatan',
  ...
  {
    question: '47. Tipe pengawasan "steering control" bertujuan...',
    choices: [
      'Mengoreksi di tengah proses',
      'Mengevaluasi hasil akhir',
      'Memberikan insentif',
      'Menghukum kesalahan'
    ],
  ...
  {
    question: '48. Pengawasan normatif berbasis pada...',
    choices: [
      'Aturan formal',
      'Anggaran keuangan',
  ...
  {
    question: '49. Prinsip "pengecualian" dalam pengawasan berarti...',
    choices: [
      'Fokus pada penyimpangan besar',
      'Mengawasi semua detail',
      'Menghindari pengawasan',
      'Delegasi penuh kepada bawahan'
    ],
    answer: 0
  },
  {
    question: '50. Tujuan pengawasan menurut Daft (2003) adalah...',
    choices: [
